...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "left-0 top-0 w-full data-[motion=from-start]:animate-in data-[motion=from-end]:animate-in data-[motion=from-start]:slide-in-from-left-1/2 data-[motion=from-end]:slide-in-from-right-1/2 data-[motion=to-start]:animate-out data-[motion=to-end]:animate-out data-[motion=to-start]:slide-out-to-left-1/2 data-[motion=to-end]:slide-out-to-right-1/2 md:absolute md:w-auto",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ref={ref}
    className={cn(
      "top-full z-10 flex h-1.5 items-end justify-center overflow-hidden data-[state=visible]:animate-in data-[state=hidden]:animate-out data-[state=hidden]:fade-out-0 data-[state=visible]:fade-in-0",
      className
    )}
    {...props}
  >
